              ...
              <Grid container className={styled.container}>
                <Grid item xs={12} sm={6} md={5} className={styled.leftCol}>
                  ...
                  <Box className={styled.image}>
                    <img
                      src={getMachineIcon(details?.code)}
                      alt="machineIcon"
                      loading="lazy"
                    />
                  </Box>
                ...
                >
                      ...
                      <Box display={'flex'} flexDirection={'row'} gap={2}>
                        {details?.oddsForPoints && (
                          <ItemChance
                            ...
                            percent={
                              (details?.oddsForPoints * 100).toFixed(1) || '-'
                            }
                          />
                        )}
                        ...
                        {details?.oddsForPrize && (
                          <ItemChance
                            ...
                            percent={
                              (details?.oddsForPrize * 100).toFixed(1) || '-'
                            }
                          />
                        )}
                        ...
                        {details?.oddsForNothing && (
                          <ItemChance
                            ...
                            percent={
                              (details?.oddsForNothing * 100).toFixed(1) || '-'
                            }
                          />
                        )}
                      </Box>
                  ...
                  >
                    ...
                    <Grid
                      ...
                      pt={{ xs: '1.5rem', md: '0' }}
                    >
                      <ButtonDefault onClick={goToGame}>
                        {t('play').toUpperCase()}
                      </ButtonDefault>
                    </Grid>
                  </Grid>
