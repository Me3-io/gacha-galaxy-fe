export const steps = [
  {
    selector: ".wallet-step",
    content:
      "Wallet Address: Here you will find the address of your active wallet. You can disconnect and connect another, anytime.",
  },
  {
    selector: ".building-step",
    content:
